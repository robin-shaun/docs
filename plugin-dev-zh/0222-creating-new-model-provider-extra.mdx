...
[  ](https://github.com/langgenius/dify-docs/edit/main/plugin-dev-zh/0222-creating-new-model-provider-extra.mdx) | [  ](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)
