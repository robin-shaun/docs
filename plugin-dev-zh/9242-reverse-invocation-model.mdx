...
[  ](https://github.com/langgenius/dify-docs/edit/main/plugin-dev-zh/9242-reverse-invocation-model.mdx) | [  ](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)
