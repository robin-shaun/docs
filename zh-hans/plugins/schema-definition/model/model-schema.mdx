...
当模型调用异常时需要映射到 Runtime 指定的 `InvokeError` 类型，方便天智针对不同错误做不同后续处理。Runtime Errors:
...
[  ](https://github.com/langgenius/dify-docs/edit/main/zh-hans/plugins/schema-definition/model/model-schema.mdx) | [  ](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)
