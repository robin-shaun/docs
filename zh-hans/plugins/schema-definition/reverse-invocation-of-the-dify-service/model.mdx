...
反向调用 Model 指的是插件能够反向调用天智内 LLM 的能力，包括平台内的所有模型类型与功能，例如 TTS、Rerank 等。
...
[  ](https://github.com/langgenius/dify-docs/edit/main/zh-hans/plugins/schema-definition/reverse-invocation-of-the-dify-service/model.mdx) | [  ](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)
