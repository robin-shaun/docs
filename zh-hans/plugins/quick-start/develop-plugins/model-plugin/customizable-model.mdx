...
如果想要将插件发布至天智Marketplace，请参考以下内容：
...
* [反向调用天智能力](/zh-hans/plugins/schema-definition/reverse-invocation-of-the-dify-service/app)
...
[  ](https://github.com/langgenius/dify-docs/edit/main/zh-hans/plugins/quick-start/develop-plugins/model-plugin/customizable-model.mdx) | [  ](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)
