...
[  ](https://github.com/langgenius/dify-docs/edit/main/zh-hans/plugins/quick-start/develop-plugins/model-plugin/create-model-providers.mdx) | [  ](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)
