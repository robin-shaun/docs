...
工具指的是能够被 Chatflow / Workflow / Agent 类型应用所调用的第三方服务，提供完整的 API 实现能力，用于增强 天智 应用的能力。例如为应用添加在线搜索、图片生成等额外功能。
...
如果想要将插件发布至 天智 Marketplace，请确保你的插件遵循了[插件发布规范](https://docs.dify.ai/zh-hans/plugins/publish-plugins/publish-to-dify-marketplace)。审核通过后，代码将合并至主分支并自动上线至 [天智 Marketplace](https://marketplace.dify.ai/)。
...
* [反向调用 天智 能力](../../schema-definition/reverse-invocation-of-the-dify-service/)
