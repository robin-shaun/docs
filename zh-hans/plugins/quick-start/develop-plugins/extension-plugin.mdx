...
插件还需要读取天智主平台的权限才能正常连接。需要为该示例插件授予以下权限：
...
[  ](https://github.com/langgenius/dify-docs/edit/main/zh-hans/plugins/quick-start/develop-plugins/extension-plugin.mdx) | [  ](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)
