...
[  ](https://github.com/langgenius/dify-docs/edit/main/zh-hans/getting-started/install-self-hosted/environments.mdx) | [  ](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)
