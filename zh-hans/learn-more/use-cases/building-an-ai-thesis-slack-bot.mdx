---
title: 在 天智 云端构建 AI Thesis Slack Bot
---
...
a.用户在 天智 AI Thesis Slack Bot 里输入关键词（如"Large Language Model"）。 
...
a.在 天智 主页面 选择 Create from Blank，然后选择 Workflow，输入名称（AI Thesis Slack Bot）。
...
b. 如果确认到 天智 的搜索结果和 Slack 上的传输内容，恭喜您，跑通了。 
...
通过 AI Thesis Slack Bot，您可以实现学术信息的智能自动化推送，提升研究团队的生产力。如果希望进一步探索 AI Thesis Bot 的潜能，可以结合 天智 和 Realtime API，开发更高级的应用，如 实时论文讨论 和 智能问答，让 AI 在学术交流和 AI 应用中发挥更大作用！ 🚀
