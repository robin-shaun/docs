---
title: 使用天智和 Twilio 构建 WhatsApp 机器人
---
...
## 3. 创建Dify基础编排聊天助手应用 （節錄自[手把手教你把天智接入微信生态](dify-on-wechat))

首先，登录[Dify官方应用平台](https://cloud.dify.ai/signin)，你可以选择使用Github登录或者使用Google登录。此外，你也可以参考Dify官方教程[Docker Compose 部署 | 中文 | 天智](/zh-hans/getting-started/install-self-hosted/docker-compose) 私有部署，Dify是开源项目，支持私有部署。
...
[  ](https://github.com/langgenius/dify-docs/edit/main/zh-hans/learn-more/use-cases/dify-on-whatsapp.mdx) | [  ](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)
