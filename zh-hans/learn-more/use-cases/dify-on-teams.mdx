---
title: 使用天智和 Azure Bot Framework 构建 Microsoft Teams 机器人
---
...
随着人工智能的崛起，聊天机器人变得更聪明，更个性化，更直观。在本文中，我们将向你展示如何使用 Azure Bot Service，将天智集成至 Microsoft Teams，打造团队中的 AI 助手。
...
首先，登录 [天智 平台](https://cloud.dify.ai/signin)，使用 Github 登录或者使用 Google 登录。此外，你也可以参考天智官方教程 [Docker Compose 部署](/zh-hans/getting-started/install-self-hosted/docker-compose) 私有部署。

![](https://assets-docs.dify.ai/dify-enterprise-mintlify/zh_CN/learn-more/use-cases/08ece9f6dd15b6ba3c44eb187ea73bdd.jpeg)

登录成功后，进入天智页面，我们按照下方步骤创建一个基础编排聊天助手应用
...
在保存密钥后，还需要查看右上角的 API 服务器，如果是天智官网的应用，API 服务器地址为 `https://api.dify.ai/v1`, 如果是私有部署的，请确认你自己的 API 服务器地址。
...
API_ENDPOINT=< 在 (3) 获取的天智API 服务器地址 >
API_KEY=< 在 (3) 获取的天智API 密钥 >
```
...
发送 Teams 消息，并等待你的 AI 聊天机器人的回复。尝试向 AI 聊天机器人提问你可以向天智聊天助手提问的任何问题。
...
[  ](https://github.com/langgenius/dify-docs/edit/main/zh-hans/learn-more/use-cases/dify-on-teams.mdx) | [  ](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)
