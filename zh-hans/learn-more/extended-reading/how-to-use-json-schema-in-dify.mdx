...
下文将简要介绍如何在天智开启并使用 JSON Schema 功能。
...
[  ](https://github.com/langgenius/dify-docs/edit/main/zh-hans/learn-more/extended-reading/how-to-use-json-schema-in-dify.mdx) | [  ](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)
