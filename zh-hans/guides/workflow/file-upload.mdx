...
天智 支持在 [ChatFlow](/zh-hans/guides/workflow/key-concepts#chatflow-和-workflow) 和 [WorkFlow](/zh-hans/guides/workflow/concepts#chatflow-和-workflow) 类型应用中上传文件，并通过[变量](/zh-hans/guides/workflow/variables)交由 LLM 处理。应用开发者可以参考以下方法为应用开启文件上传功能：
...
[  ](https://github.com/langgenius/dify-docs/edit/main/zh-hans/guides/workflow/file-upload.mdx) | [  ](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)
