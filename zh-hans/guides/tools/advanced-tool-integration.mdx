...
在开始接入工具之前，请确保你已经阅读过[快速接入](/zh-hans/user-guide/tools/quick-tool-integration)，并对天智的工具接入流程有了基本的了解。
...
该工具需要传入 user\_id 和需要进行总结的文本，返回一个总结后的文本，天智 会使用当前工作空间的默认模型对长文本进行总结。
...
[  ](https://github.com/langgenius/dify-docs/edit/main/zh-hans/guides/tools/advanced-tool-integration.mdx) | [  ](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)
