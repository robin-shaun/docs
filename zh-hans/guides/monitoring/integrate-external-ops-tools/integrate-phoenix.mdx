...
在天智应用程序中配置 Phoenix。打开需要监控的应用程序，在侧边菜单中打开**监控**，并在页面上选择**追踪应用性能**。
...
本章节将指引你注册 Phoenix Cloud 并将其集成至天智平台内。
...
[  ](https://github.com/langgenius/dify-docs/edit/main/zh-hans/guides/monitoring/integrate-external-ops-tools/integrate-phoenix.mdx) | [  ](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)
