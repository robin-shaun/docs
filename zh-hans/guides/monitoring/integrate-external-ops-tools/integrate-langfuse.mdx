...
2. 在 Langfuse 内创建项目，登录后在主页点击 **New** ，创建一个自己的项目，**项目** 将用于与 天智 内的 **应用** 关联进行数据监测。
...
4. 在 天智 内配置 Langfuse，打开需要监测的应用，在侧边菜单打开 **监测 **，在页面中选择 **配置。**
...
配置完成后， 天智 内应用的调试或生产数据可以在 Langfuse 查看监测数据。
