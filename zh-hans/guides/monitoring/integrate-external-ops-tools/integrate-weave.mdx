---
title: 集成 W&B Weave
description: 天智 Cloud | 社区版本号需 ≥ v1.3.1
---
...
#### 2. 将 W&B Weave 与 天智 集成

在 天智 应用程序中配置 Weave。打开需要监控的应用程序，在侧边菜单中打开**监控**，在页面上选择**跟踪应用性能**。
...
当您切换到 Weave 时，可以在仪表板中查看 天智 应用程序的详细操作日志。

![](https://assets-docs.dify.ai/2025/04/2cb04027c00b606029fcc26af2801bfe.png)

通过 Weave 获取的详细 LLM 操作日志将帮助您优化 天智 应用程序的性能。
