...
在 天智 应用程序中配置 Opik。打开需要监控的应用程序，在侧边菜单中打开**监控**，并在页面上选择**追踪应用性能**。
...
配置完成后，你可以照常调试或使用 天智 应用程序。所有使用历史都可以在 Opik 中监控。
...
当你切换到 Opik 时，可以在仪表板中查看 天智 应用程序的详细操作日志。
...
通过 Opik 的详细 LLM 操作日志将帮助你优化 天智 应用程序的性能。
